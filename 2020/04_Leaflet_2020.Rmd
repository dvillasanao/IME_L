...
```{r}
## Shapefiles
shape_estados <- geojsonio::geojson_read(paste0(here::here(), "/2020/Output/Shapes/estados_json.geojson"), what = "sp")
...
```{r, results=FALSE}
state_popup_1 <- readRDS(paste0(here::here(), "/2020/Output/PopUp/state_popup_estados1.RDS"))
state_popup_2 <- readRDS(paste0(here::here(), "/2020/Output/PopUp/state_popup_estados2.RDS"))
state_popup_3 <- readRDS(paste0(here::here(), "/2020/Output/PopUp/state_popup_estados3.RDS"))
state_popup_4 <- readRDS(paste0(here::here(), "/2020/Output/PopUp/state_popup_estados4.RDS"))
state_popup_5 <- readRDS(paste0(here::here(), "/2020/Output/PopUp/state_popup_estados5.RDS"))
```
...
#saveRDS(leaflet_estados, paste0(here::here(), "/2020/Graficos/leaflet.RDS"))
#saveWidget(leaflet_estados, paste0(here::here(), "/2020/Graficos/leaflet.html"), selfcontained = TRUE)

leaflet_estados <- leaflet_estados %>% 
                    mapshot(url = paste0(here::here(), "/IME_2020.html")) 
```
